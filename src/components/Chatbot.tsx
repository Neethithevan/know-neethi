...
const Chatbot = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "1",
      text: "Hi there! I'm John's AI assistant. I can tell you about his experience, projects, skills, and answer any questions you might have about working with him. How can I help you today?",
      isBot: true,
      timestamp: new Date()
    }
  ]);
  ...
  const botResponses = {
    greetings: [
      "Hello! I'm here to tell you all about John's amazing work and experience. What would you like to know?",
      "Hi there! Great to meet you. I'd be happy to share information about John's skills and projects.",
      "Hey! Welcome to John's portfolio. I'm his AI assistant - ask me anything about his background!"
    ],
    experience: [
      "John has over 5 years of experience as a full-stack developer. He's currently a Senior Full Stack Developer at TechCorp Solutions, where he leads a team of 5 developers and has improved system performance by 40%.",
    ...
    projects: [
      "John has worked on some incredible projects! His featured work includes an e-commerce platform with full payment processing, a collaborative task management app with real-time updates, and an AI-powered content generator using OpenAI's API.",
    ...
    skills: [
      "John is proficient in React, Node.js, TypeScript, PostgreSQL, AWS, Docker, and many other modern technologies. He's also AWS certified and has Google Cloud Professional Developer certification.",
    ...
    contact: [
      "You can reach John at john.doe@example.com or connect with him on LinkedIn. He's always open to discussing new opportunities and collaborations!",
      "John is based in San Francisco and is available for both remote and local opportunities. Feel free to use the contact form on this page to get in touch!"
    ],
    default: [
      "That's a great question! While I can tell you about John's professional background, projects, and skills, you might want to reach out to him directly for more specific information. Would you like his contact details?",
      "I'd love to help with that! For detailed discussions about specific projects or collaborations, I'd recommend contacting John directly. What else can I tell you about his experience?",
      "Interesting question! John would be the best person to give you a detailed answer on that. In the meantime, is there anything else about his background or projects I can help with?"
    ]
  };
